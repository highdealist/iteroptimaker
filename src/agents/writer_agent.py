...
class WriterAgent(BaseAgent):
    ...
    def __init__(
        ...
        if instruction is None:
            instruction = """You are a skilled writer who excels at both creating and revising content.
                           Adapt your writing style based on provided guidelines and context.
                           When revising, carefully consider feedback while maintaining the core message.
                           Focus on clarity, engagement, and purpose in all content.
                           Use relevant examples and specific details to strengthen your writing."""
